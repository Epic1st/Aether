                            ...
                            <View style={{ marginBottom: 24 }}>
                                ...
                                >
                                    {poaUploaded ? (
                                        ...
                                        <View style={{ alignItems: 'center' }}>
                                            <DepositIcon color={colors.lavender} />
                                            <Text style={{ fontSize: 14, fontWeight: '600', color: colors.textPrimary, marginTop: 8 }}>Upload Address Proof</Text>
                        ...
                        <>
                            ...
                            <View style={{ gap: 16 }}>
                                <View>
                                    ...
                                    <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: isDark ? colors.cardDark : colors.white, borderRadius: 14, paddingHorizontal: 16, gap: 12, borderWidth: 1, borderColor: isDark ? 'transparent' : colors.grayLight + '33' }}>
                                        <UserIcon />
                                        <TextInput style={{ flex: 1, height: 52, fontSize: 15, color: colors.textPrimary }} placeholder="As on ID document" placeholderTextColor={colors.gray} value={name} onChangeText={setName} />
                                    </View>
                                </View>

                                <View>
                                    <Text style={{ fontSize: 13, color: colors.grayLight, marginBottom: 8 }}>Date of Birth</Text>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: isDark ? colors.cardDark : colors.white, borderRadius: 14, paddingHorizontal: 16, borderWidth: 1, borderColor: isDark ? 'transparent' : colors.grayLight + '33' }}>
                                        <TextInput style={{ flex: 1, height: 52, fontSize: 15, color: colors.textPrimary }} placeholder="DD/MM/YYYY" placeholderTextColor={colors.gray} value={dob} onChangeText={setDob} keyboardType="numeric" />
                                    </View>
                                </View>
                                ...
                                <View>
                                    ...
                                    <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: isDark ? colors.cardDark : colors.white, borderRadius: 14, paddingHorizontal: 16, borderWidth: 1, borderColor: isDark ? 'transparent' : colors.grayLight + '33' }}>
                                        <TextInput style={{ flex: 1, height: 52, fontSize: 15, color: colors.textPrimary }} placeholder="Select your country" placeholderTextColor={colors.gray} value={country} onChangeText={setCountry} />
                                    </View>
                                </View>
                            </View>
                        </>
